...
const props=defineProps<{document:KnowledgeDocument|null;desktopAvailable:boolean}>();defineEmits<{(event:'open',id:number):void;(event:'rebuild',id:number):void;(event:'delete',id:number):void}>()
