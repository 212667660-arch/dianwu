...
import { Menu, Reading, Refresh } from '@element-plus/icons-vue'
...
function useSuggestion(prompt: string) { drawerOpen.value = false; router.push({ path: '/tutor', query: { prompt } }) }
onMounted(async () => {
