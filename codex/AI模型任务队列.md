...
| S-037 | P0 | 进行中 | 对全部前端、后端、Electron 和最终桌面包执行发布级验收 | S-033、S-034、S-035、S-036 | 全量测试、构建、PyInstaller、desktop pack、生命周期、真实 OCR/导入和零残留进程证据 |
